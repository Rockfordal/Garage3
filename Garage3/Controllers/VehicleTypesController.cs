...
namespace Garage3.Controllers
{
    public class VehicleTypesController : ApiController
    {
        ...
        public IQueryable<VehicleType> Getdb_VehicleTypes()
        {
            return db.db_VehicleTypes;
        }
        ...
        {
            VehicleType vehicleType = db.db_VehicleTypes.Find(id);
            if (vehicleType == null)
            {
                return NotFound();
            }
        ...
        public IHttpActionResult PostVehicleType(VehicleType vehicleType)
        {
            ...
            db.db_VehicleTypes.Add(vehicleType);
            db.SaveChanges();
        ...
        public IHttpActionResult DeleteVehicleType(int id)
        {
            ...
            db.db_VehicleTypes.Remove(vehicleType);
            db.SaveChanges();
        ...
        {
            return db.db_VehicleTypes.Count(e => e.Id == id) > 0;
        }
    }
}